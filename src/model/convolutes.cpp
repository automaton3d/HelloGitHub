 ...
 *   r2 == effective_r2(t)     — cell is on the active wavefront
 *   effective_r2(t) == (RMAX/2)²  — wavefront is at mid-radius
...
namespace automaton
{
  ...
  {
    if (curr.r2 == effective_r2(curr.t) && effective_r2(curr.t) == (RMAX / 2) * (RMAX / 2) && curr.x[3] == 0 && ctrl)
    {
  ...
  {
    if (curr.r2 == effective_r2(curr.t) && effective_r2(curr.t) == (RMAX / 2) * (RMAX / 2) && curr.sB && curr.x[3] == 0 && ctrl)
    {
      draft.hB = true;
      ctrl = false;
    }
  ...
  {
    if (curr.r2 == effective_r2(curr.t) && effective_r2(curr.t) == (RMAX / 2) * (RMAX / 2) && curr.pB && curr.x[3] == 0 &&
  ...
  {
    if (curr.r2 == effective_r2(curr.t) && mirror.r2 == effective_r2(mirror.t))
    {
          ...
          curr.x[2] == mirror.x[2])
      {
        if (curr.a != W_USED &&
            curr.W1() != mirror.W1() &&
            !curr.cB &&
            effective_r2(curr.t) == (RMAX / 2) * (RMAX / 2))
        {
  ...
  bool convolute7(Cell& curr, Cell &draft, Cell &mirror)
  {
    if (curr.r2 == effective_r2(curr.t) && mirror.r2 == effective_r2(mirror.t))
    {
          ...
          curr.x[2] == mirror.x[2])
      {
        ...
        // A2) Phase-locked superposition (f² == effective_r2)
        else if (curr.f * curr.f == effective_r2(curr.t) && mirror.f * mirror.f == effective_r2(mirror.t))
        {
      ...
      else
      {
        ...
        if (curr.W1() == mirror.W1())
        {
          if (curr.ch == mirror.ch &&
              curr.f * curr.f == effective_r2(curr.t) &&
              mirror.f * mirror.f == effective_r2(mirror.t))
          {
            if (curr.a > mirror.a)
            {
